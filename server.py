...
class VoyaFlightHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # Clean URL mapping for Amtrak & VIA Rail landing pages
        if parsed.path in ('/amtrak', '/amtrak/'):
            self.path = '/amtrak.html'
        elif parsed.path in ('/viarail', '/viarail/', '/via-rail', '/via-rail/'):
            self.path = '/viarail.html'
    ...
    def do_HEAD(self):
        ...
        if req_path in ('/amtrak', '/amtrak/'):
            self.path = '/amtrak.html'
        elif req_path in ('/viarail', '/viarail/', '/via-rail', '/via-rail/'):
            self.path = '/viarail.html'
